    ...
    lines.extend(
        [
            ...
            (
                ...
                r"are the conventional midpoint thresholds from the sweep grid and "
                r"are retained as the global main-text setting rather than selecting "
                r"model- or method-specific thresholds; the appendix exposes the "
                r"10/25/50\% and 0.70/0.80/0.90/0.95 sweeps. Boldface inside the "
