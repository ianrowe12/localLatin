    ...
    lines.extend(
        [
            ...
            (
                ...
                r"the expanded 10/25/50\% sufficiency/comprehensiveness sweep and the "
                r"0.70/0.80/0.90/0.95 MinFrac sweep in Appendix Tables~"
                r"\ref{tab:attribution_sweep_main_methods} and~"
                r"\ref{tab:attribution_sweep_supplemental_methods}; "
                r"Figure~\ref{fig:attribution_rho_loo_main} shows the foreground "
                r"$\rho_{\text{LOO}}$ summary. Boldface inside the "
