...
The attribution results need a narrow reading. ABTT changes the cosine being explained, so only the leave-one-out rank gain is stable across all six cells.
