...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Promote top GAP configs to full retrieval eval."
    )
    ...
    parser.add_argument(
        "--output_csv",
        default="phase3_full_eval_scoreboard.csv",
...
def main() -> None:
    ...
    output_path = (
        ...
        if args.output_csv
        else screening_path.parent / "phase3_full_eval_scoreboard.csv"
    )
