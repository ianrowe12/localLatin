...
`professor_share/` is now organised by date:

- `2026-04-20/` — first all-models share (superseded).
- `2026-04-23/` — 200-random-pair share + drafted messages (superseded
  by 200pos run; do **not** send these to the professor).
- `2026-04-26/` — **the bundle to send Monday** (everything below).
- `2026-04-27/` — this `READY.md`.

All filenames named below live in `../2026-04-26/` unless otherwise noted.

## What's in the bundle (all in `../2026-04-26/`)
