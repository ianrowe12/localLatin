#!/usr/bin/env python
"""200-pair variant of make_charts.py — reads the regenerated summary CSV and
writes *_200pair.{pdf,png} charts alongside the 20-pair originals.

See make_charts.py for shared infrastructure; this file duplicates the light
wrapper to keep the outputs labelled.
"""
...
SUMMARY = REPO / "runs/active/ig_examples_200pair/attribution_metrics/summary.csv"
...
def main() -> None:
    ...
    grouped_bar(
        ...
        models=t5,
        title=r"$\rho_{\mathrm{LOO}}$ (200 random test pairs/model; T5 main-text scope)",
        out_path=OUT / "chart_rho_loo_t5_200pair.pdf",
        se_col="loo_rho_se",
    )
    ...
    grouped_bar(
        ...
        direction="higher is better",
        models=t5,
        title="Sufficiency@25% (200 random test pairs/model; T5 main-text scope)",
        out_path=OUT / "chart_suff25_t5_200pair.pdf",
