"""Phase 9 Experiment 2: Core layer-wise evaluation on MUSTS.

Reads 50/50 split CSVs (from data_prep), encodes with caching,
evaluates 3 methods: baseline_mean, sif_abtt_optimal, whitening.

Models: LaBSE (~0.5B encoder), Qwen2.5-Embedding-0.5B (decoder),
        KaLM-embedding-multilingual-mini-instruct-v2.5 (decoder_wrapped).
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Phase 9 Exp 2 evaluation.")
    ...
    parser.add_argument(
        "--languages", default="english,french,sinhala,tamil,serbian",
    ...
    parser.add_argument("--layers", default="", help="Layer range, e.g. 0-12.")
